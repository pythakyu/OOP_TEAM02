        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	if (!isSaving) {
                    ...
                    // Call saveToFile method from TodoListSave
                    TodoListSave todoListSave = new TodoListSave(ToDoList.this, todoItems);
...
//----------------------------------------------------------------------------------------------//
    ...
    private void changeTheme() {
    	...
    	for (TodoItem item : todoItems) {
    	    ...
    	    JLabel remainingDaysLabel = item.getRemainingLabel();
    	    ...
    	    if (isDarkMode) {
    	        ...
    	        remainingDaysLabel.setForeground(Color.WHITE);
    	        ...
    	        remainingDaysLabel.setForeground(Color.BLACK);
